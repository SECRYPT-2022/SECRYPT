...
- The version of the Polygon Edge.    
  (*Confirm the version of your Polygon edge client by running the following command: `secrypt version --grpc-address GRPC_ADDRESS`*)
...
- Provide us with the peer list of each of your validators by running the following command: `secrypt peers list --grpc-address GRPC_ADDRESS`.
