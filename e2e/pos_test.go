...
import (
	...
	"github.com/SECRYPT-2022/SECRYPT/contracts/staking"
	"github.com/SECRYPT-2022/SECRYPT/crypto"
	"github.com/SECRYPT-2022/SECRYPT/e2e/framework"
	stakingHelper "github.com/SECRYPT-2022/SECRYPT/helper/staking"
	"github.com/SECRYPT-2022/SECRYPT/helper/tests"
	txpoolOp "github.com/SECRYPT-2022/SECRYPT/txpool/proto"
	...
	ibftManager := framework.NewIBFTServersManager(
		...
		func(i int, config *framework.TestServerConfig) {
			if i < numGenesisValidators {
				...
				dirPrefix := "secrypt-non-validator-"
