...
build:
	...
	go build -o secrypt -ldflags="\
    	-X 'github.com/SECRYPT-2022/SECRYPT/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/SECRYPT-2022/SECRYPT/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/SECRYPT-2022/SECRYPT/versioning.Branch=$(BRANCH)'\
		-X 'github.com/SECRYPT-2022/SECRYPT/versioning.BuildTime=$(TIME)'" \
	main.go
...
test-e2e:
	...
	go build -race -o artifacts/secrypt .
	env EDGE_BINARY=${PWD}/artifacts/secrypt go test -v -timeout=30m ./e2e/...
